    ...
    <header className="sticky top-0 z-50 border-b border-outline-variant/30 bg-surface/75 shadow-sm backdrop-blur-xl">
      <nav className="mx-auto flex h-20 max-w-content items-center justify-between px-4 md:px-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="/designArchitecture"
            className="hidden rounded-full border border-primary bg-primary px-6 py-2.5 font-mono text-xs font-semibold uppercase text-on-primary transition-all hover:opacity-90 md:inline-flex"
          >
            Design Architecture
          </a>
          <button
      ...
      <div className="mx-auto grid max-w-content grid-cols-1 items-center gap-16 px-4 md:px-16 lg:grid-cols-2">
        <div className="z-10 flex flex-col items-start gap-8">
          ...
          <div className="mt-2 flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
            ...
            <a
              href="#community"
              className="inline-flex items-center justify-center rounded-full border border-primary px-8 py-4 font-mono text-xs font-semibold uppercase text-primary transition-colors hover:bg-primary hover:text-on-primary"
            >
              Join Free Community
            </a>
            <a
